...
def calc_hr_and_spo2(ir_data, red_data):
    ...
    if n_peaks >= 2:
        ...
        hr = int((SAMPLE_FREQ * 60 / peak_interval_sum)-13)
        hr_valid = True
    else:
        hr = 80  # unable to calculate because # of peaks are too small
        hr_valid = False
    ...
    for i in range(exact_ir_valley_locs_count):
        if ir_valley_locs[i] > BUFFER_SIZE:
            spo2 = 95  # do not use SPO2 since valley loc is out of range
            spo2_valid = False
